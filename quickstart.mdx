...
<Icon icon="book-open" />
<Icon icon="book-open" iconType="duotone" />
<Icon icon="book-open" iconType="duotone" size={24} />
<Icon icon="book-open" iconType="duotone" size={24} color="#FF00FF" />

this is an inline <Icon icon="book-open" /> icon
this is an inline <Icon icon="book-open" iconType="duotone" /> icon
this is an inline <Icon icon="book-open" iconType="duotone" size={24} /> icon
this is an inline <Icon icon="book-open" iconType="duotone" size={24} color="#FF00FF" /> icon
...
<Note>
  ...
  Interested? Request it [here](mailto:josh@mintlify.com)
</Note>
